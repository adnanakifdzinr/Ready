...
export function ServicesSection() {
  ...
  return (
    <section className="w-full bg-[#f9f9f9] py-20 md:py-20 lg:py-20 px-3 md:px-5 lg:px-8">
      <div className="max-w-full mx-auto">
        <HeadingAnimation className="space-y-0 md:space-y-2 overflow-hidden -mt-2 md:mt-0 mb-16 text-center" ref={servicesRef}>
          <h2 className="text-5xl lg:text-[64px] font-medium text-black mb-0 leading-none tracking-tighter">
            How we can help you
          </h2>
        </HeadingAnimation>
